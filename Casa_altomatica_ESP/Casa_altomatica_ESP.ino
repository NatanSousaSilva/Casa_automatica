...
const char* ssid = "Casa_Automatica";
...
<body>
  ...
  <form action='/perifericos' method='GET'><button type='submit'>Periféricos</button></form>
</body></html>
)rawliteral";
...
<h2>Alpendre (frente)</h2>
<form action='/luzes' method='GET'>
  <button name='btnl' value='alpendre_frente_on'>Ligar</button>
  <button name='btnl' value='alpendre_frente_off'>Desligar</button>
</form>

<h2>Alpendre (lado)</h2>
<form action='/luzes' method='GET'>
  <button name='btnl' value='alpendre_lado_on'>Ligar</button>
  <button name='btnl' value='alpendre_lado_off'>Desligar</button>
</form>

<h2>Internas</h2>
<form action='/luzes' method='GET'>
  <button name='btnl' value='internas_on'>Ligar</button>
  <button name='btnl' value='internas_off'>Desligar</button>
</form>
...
<form action='/sensores' method='GET'>
  <button name='btns' value='fumaca_on'>Ativar</button>
  <button name='btns' value='fumaca_off'>Desativar</button>
</form>
<a href='/'>⬅ Voltar</a>
</body></html>
)rawliteral";
...
void controle_luzes() {
  if (server.hasArg("btnl")) {
    ...
    if (botao == "alpendre_frente_on") mensagem = 190;
    else if (botao == "alpendre_frente_off") mensagem = 191;
    else if (botao == "alpendre_lado_on") mensagem = 192;
    else if (botao == "alpendre_lado_off") mensagem = 193;
    else if (botao == "internas_on") mensagem = 194;
    else if (botao == "internas_off") mensagem = 185;
  }
...
void controle_sensores() {
  if (server.hasArg("btns")) {
    ...
    if (botao == "fumaca_on") mensagem = 200;
    else if (botao == "fumaca_off") mensagem = 201;
  }
...
void controle_perifericos() {
  if (server.hasArg("btnp")) {
    ...
    if (botao == "porta_aberta") mensagem = 211;
    else if (botao == "porta_fechada") mensagem = 212;
  }
